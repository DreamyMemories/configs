...
alias ltttt=' ls --tree -D -L 5 -I ${TREE_IGNORE}'eval 
TWILIO_AC_ZSH_SETUP_PATH=/home/wei/.twilio-cli/autocomplete/zsh_setup && test -f $TWILIO_AC_ZSH_SETUP_PATH && source $TWILIO_AC_ZSH_SETUP_PATH; # twilio autocomplete setup
